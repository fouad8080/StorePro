    ...
    <div className="p-4">
        <div className="flex justify-between items-center mb-4">
            <div className="">
                ...
                <p className="font-semibold text-gray-600">Manage and view all your customers</p>
            </div>
            <div className="flex space-x-2 gap-2">
                <button className="border-[#dbd7d7] border flex gap-2 items-center  px-4 py-2 rounded-md hover:bg-[#e3dfdf]"><Download className="w-4 h-4" /> import Customers</button>
